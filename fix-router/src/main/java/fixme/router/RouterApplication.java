...
public class RouterApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("  - 1 I/O Thread (event loop)");
            logger.info("  - {} Message Processor Threads (handler chain)", MESSAGE_PROCESSOR_THREADS);
            logger.info("");
            ...
            logger.info("  4. Forward messages to destination");
            logger.info("");
